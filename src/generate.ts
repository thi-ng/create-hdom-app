...
const FILES: FileSpecs = {
    default: {
        ...
        default: [
            ...
            ["handlers.default.ts", ["src", "handlers.ts"]],
        ...
        nr: [
            ...
            ["effects.nr.ts", ["src", "effects.ts"]],
            ["events.nr.ts", ["src", "events.ts"]],
            ["event-link.ts", ["src", "components", "event-link.ts"]],
            ["handlers.default.ts", ["src", "handlers.ts"]],
    ...
    minimal: {
        ...
        default: [
            ...
            ["effects.min.default.ts", ["src", "effects.ts"]],
            ["events.min.default.ts", ["src", "events.ts"]],
            ["event-link.ts", ["src", "components", "event-link.ts"]],
            ["handlers.min.ts", ["src", "handlers.ts"]],
            ["routes.min.ts", ["src", "routes.ts"]],
            ["route-link.ts", ["src", "components", "route-link.ts"]],
        ],
        ne: [
        ...
        nr: [
            ...
            ["effects.min.nr.ts", ["src", "effects.ts"]],
            ["events.min.nr.ts", ["src", "events.ts"]],
            ["event-link.ts", ["src", "components", "event-link.ts"]],
            ["handlers.min.ts", ["src", "handlers.ts"]],
        ],
        nre: [
